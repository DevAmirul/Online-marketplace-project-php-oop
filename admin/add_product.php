        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                ...
                <div class="form-group brand">
                    ...
                    $brand_cat = $db->getResult();?>
                    <select class="form-control product_brands" name="product_brand">
                        <option value="" selected disabled>First Select brand</option>
                        <?php if ($brand_cat > 0) {  
                            foreach($brand_cat as $brand_category) { ?>
                            <option value="<?php echo $brand_category['brand_id']; ?>"><?php echo $brand_category['brand_title']; ?></option>
                            <?php } 
                            } ?>
                    </select>
                </div>
